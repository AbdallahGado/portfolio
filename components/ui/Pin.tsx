  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{ transform }}
          className="absolute p-4 flex justify-start items-start rounded-2xl shadow-lg border border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden"
        >
        ...
        >
          {Array.from({ length: 3 }).map((_, index) => (
            <motion.div
              ...
              className="absolute left-1/2 top-1/2 h-[11.25rem] w-[11.25rem] rounded-[50%] bg-sky-500/[0.08] shadow-lg"
            ></motion.div>
          ))}
        </div>
